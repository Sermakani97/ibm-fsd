...
//public Customer(String name, String email, String password, String customerId, Set<Product> products) {
//	super();
//	this.name = name;
//	this.email = email;
//	this.password = password;
...
//public Customer(String name, String email, String password,List<Product> p) {
//	super();
//	this.name = name;
//	this.email = email;
//	this.password = password;
